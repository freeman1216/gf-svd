...
g++ gf2.cpp -o gf2 -g -I/usr/include/libxml2 -lxml2  -O2 -lX11 -pthread $extra_flags -Wall -Wextra -Wno-unused-parameter -Wno-unused-result -Wno-missing-field-initializers -Wno-format-truncation || exit 1
